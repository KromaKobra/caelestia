...
Item {
    ...
    StyledText {
        ...
        color: Hyprland.activeWsId === root.ws ? Colours.palette.m3tertiary : (Config.bar.workspaces.occupiedBg || root.isOccupied ? Colours.palette.m3onSurface : Colours.palette.m3outlineVariant)
