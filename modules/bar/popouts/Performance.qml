...
RowLayout {
    ...
    component Resource: Item {
        ...
        readonly property real primaryMult: primary ? 0.5 : 0.45

        readonly property real thickness: Config.bar.sizes.resourceProgessThickness * primaryMult
        ...
        implicitWidth: Config.bar.sizes.resourceSize * primaryMult
        implicitHeight: Config.bar.sizes.resourceSize * primaryMult
